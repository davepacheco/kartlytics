...
With -T, force regenerating race transcripts of races that already have
transcripts.
...
echo -n | mjob create -w \
    ...
    -m "/assets$ra_binroot/video-transcribe $ra_forcetranscribe /var/tmp/kartlytics \"$ra_outdir\" "'$MANTA_INPUT_FILE' || \
